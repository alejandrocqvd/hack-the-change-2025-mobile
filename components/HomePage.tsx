...
export default function Home() {
  const reports = [
    { type: "Fence", title: "Broken fence", date: "Nov 8 • 7:20 PM", status: "Open", location: "Chaparral" },
    { type: "Road Hazard", title: "Pothole on Main St.", date: "Nov 7 • 5:45 PM", status: "In Progress", location: "Main St. & 3rd Ave" },
    { type: "Lighting", title: "Streetlight out", date: "Nov 5 • 10:10 PM", status: "Closed", location: "Downtown" },
  ];
